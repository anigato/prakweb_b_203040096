...
<body>
         ...
         <div class="card-body">
            <form class="row g-3 needs-validation" novalidate id="inputProduct" method="post" action="" enctype="multipart/form-data">
               <div class="form-floating col-md-6">
                  <input type="text" class="form-control" id="inputTitle" name="inputTitle" required placeholder="Judul Buku">
               ...
               <div class="form-floating col-md-6">
                  <input type="text" class="form-control" id="inputWritter" name="inputWritter" required placeholder="Nama Penulis">
               ...
               <div class="form-floating col-md-6">
                  <input type="text" class="form-control" id="inputPublisher" name="inputPublisher" required placeholder="Nama Penerbit">
               ...
               <div class="form-floating col-md-6">
                  <input type="text" class="form-control" id="inputPublished" name="inputPublished" required placeholder="Tahun Diterbitkan" onkeypress="return onlyNumber(event)" minlength="4" maxlength="4">
               ...
               <div class="col-12">
                  <div class="mb-3">
                     ...
                     <input class="form-control" type="file" id="img" name="img" required onchange="showImage(this);">
                     <div class="invalid-feedback">
                  ...
                  <div class="col-12">
                     <button type="submit" class="btn btn-success" name="tambah"><i class="fa-solid fa-upload"></i> Tambahkan</button>
                     <!-- <button type="button" class="btn btn-warning" onclick="resetForm()"><i class="fa-solid fa-arrows-rotate"></i> Reset</button> -->
   ...
   if (isset($_POST['tambah'])) {
      $upload = uploadImage('asset/img/', $_POST, 'upload-product');
      if ($upload == "success") {
         echo "
